...
from utils import *
import sys
# 使用 tf_slim 的 batch_norm 以匹配 checkpoint 变量命名
try:
...
def batch_norm_compat(x, is_training=False, scope=None):
...
def convoffset2D(x, y, scope_name=None):
	...
	with tf.compat.v1.variable_scope(scope_name):
		with tf.compat.v1.variable_scope('offset_conv'):
			...
			offsets1 = batch_norm_compat(offsets1)
			...
			offsets2 = batch_norm_compat(offsets2)
			...
			offsets3 = batch_norm_compat(offsets3)
			...
			offsets5 = conv(offsets3_ds, channels=32, kernel=3, stride=1, pad=1, pad_type='reflect', scope='conv5',
							use_bias=True)
			offsets5 = batch_norm_compat(offsets5)
			...
			offsets6 = batch_norm_compat(offsets6)
			...
			offsets7 = batch_norm_compat(offsets7)
			...
			offsets8 = batch_norm_compat(offsets8)
			...
			offsets10 = batch_norm_compat(offsets10)
